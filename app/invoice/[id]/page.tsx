    ...
    <div className="bg-white min-h-screen text-black">
      ...
      <div className="print:hidden fixed top-4 right-4 flex gap-4">
        <button
          ...
          className="bg-black text-white px-6 py-2 rounded-md font-semibold flex items-center gap-2 hover:bg-gray-800"
        >
          <Printer size={18} /> Print Invoice
        </button>
      </div>

      <div className="max-w-3xl mx-auto p-12 print:p-6 border border-gray-300 print:border-none shadow-sm mt-8 print:mt-0 relative bg-white">
        ...
        {/* Header */}
        <div className="relative z-10 flex justify-between items-start border-b-2 border-black pb-8 mb-8 print:pb-4 print:mb-4">
          <div>
            <div className="flex flex-col gap-2 mb-4">
              <img src="/logo.png" alt="Kutchi Handmade Logo" className="h-25 w-25 object-cover rounded-full shadow-sm" />
        ...
        {/* Bill To */}
        <div className="relative z-10 mb-8 print:mb-4 p-6 print:p-4 bg-gray-50/70 backdrop-blur-sm rounded-xl border border-gray-400 grid grid-cols-2 gap-8">
          <div>
        ...
        {/* Items Table */}
        <div className="relative z-10 bg-white/70 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-400 mb-8 print:mb-4">
            ...
            <tbody>
              {items.map((item, index) => (
                <tr key={index} className="border-b border-gray-300 last:border-0 hover:bg-gray-50/50 transition-colors">
                  <td className="py-5 print:py-1.5 px-6 print:px-4 print:text-sm font-medium text-black">{item.product_name}</td>
        ...
        <div className="relative z-10 flex justify-end mb-16 print:mb-4">
          <div className="w-72 bg-gray-50/70 backdrop-blur-sm p-6 rounded-xl border border-gray-400">
            {hasDiscount && (
